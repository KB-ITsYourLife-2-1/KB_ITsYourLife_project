...
dt_.rename(columns={'배추_거래량(kg)':'배추', '양파_거래량(kg)':'양파','마늘_거래량(kg)':'마늘',  '깻잎_거래량(kg)':'깻잎',
       '대파_거래량(kg)':'대파', '상추_거래량(kg)':'상추', '양상추_거래량(kg)':'양상추', '무_거래량(kg)':'무', '시금치_거래량(kg)':'시금치'}, inplace=True)
dt_[['배추', '양파', '마늘', '깻잎', '대파', '상추', '양상추', '무', '시금치']] = dt_[['배추', '양파', '마늘', '깻잎', '대파', '상추', '양상추', '무', '시금치']].round(1)
...
plt.savefig('statistic_p1.png', bbox_inches='tight', pad_inches=0.3)
...
plt.savefig('statistic_p2.png', bbox_inches='tight', pad_inches=0.3)
...
for rect in bar3:
    height = rect.get_height()
    plt.text(rect.get_x() + rect.get_width()/2.0, height*0.99, '%.1f' % height, ha='center', va='bottom', size = 12)
plt.savefig('statistic_p3.png', bbox_inches='tight', pad_inches=0.3)
...
for rect in bar4:
    height = rect.get_height()
    plt.text(rect.get_x() + rect.get_width()/2.0, height*0.99, '%.1f' % height, ha='center', va='bottom', size = 12)
plt.savefig('statistic_p4.png', bbox_inches='tight', pad_inches=0.3)
...
for rect in bar5:
    height = rect.get_height()
    plt.text(rect.get_x() + rect.get_width()/2.0, height*0.99, '%.1f' % height, ha='center', va='bottom', size = 12)
plt.savefig('statistic_p5.png', bbox_inches='tight', pad_inches=0.3)
...
for rect in bar6:
    height = rect.get_height()
    plt.text(rect.get_x() + rect.get_width()/2.0, height*0.99, '%.1f' % height, ha='center', va='bottom', size = 12)
plt.savefig('statistic_p6.png', bbox_inches='tight', pad_inches=0.3)
...
for rect in bar7:
    height = rect.get_height()
    plt.text(rect.get_x() + rect.get_width()/2.0, height*0.99, '%.1f' % height, ha='center', va='bottom', size = 12)
plt.savefig('statistic_p7.png', bbox_inches='tight', pad_inches=0.3)
...
for rect in bar8:
    height = rect.get_height()
    plt.text(rect.get_x() + rect.get_width()/2.0, height*0.99, '%.1f' % height, ha='center', va='bottom', size = 12)
plt.savefig('statistic_p8.png', bbox_inches='tight', pad_inches=0.3)
...
for rect in bar9:
    height = rect.get_height()
    plt.text(rect.get_x() + rect.get_width()/2.0, height, '%.1f' % height, ha='center', va='bottom', size = 12)
plt.savefig('statistic_p9.png', bbox_inches='tight', pad_inches=0.3)
...
plt.savefig('statistic_p1_.png', bbox_inches='tight', pad_inches=0.3)
...
plt.savefig('statistic_p2_.png', bbox_inches='tight', pad_inches=0.3)
...
plt.savefig('statistic_p3_.png', bbox_inches='tight', pad_inches=0.3)
...
plt.savefig('statistic_p4_.png', bbox_inches='tight', pad_inches=0.3)
...
plt.savefig('statistic_p5_.png', bbox_inches='tight', pad_inches=0.3)
...
plt.savefig('statistic_p6_.png', bbox_inches='tight', pad_inches=0.3)
...
plt.savefig('statistic_p7_.png', bbox_inches='tight', pad_inches=0.3)
...
plt.savefig('statistic_p8_.png', bbox_inches='tight', pad_inches=0.3)
...
plt.savefig('statistic_p9_.png', bbox_inches='tight', pad_inches=0.3)
