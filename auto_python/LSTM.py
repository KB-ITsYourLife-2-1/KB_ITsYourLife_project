...
submmision.to_csv(f'../statistic/static/graph/predict_{today}.csv')

if os.path.exists(f'../statistic/static/graph/predict_{last}.csv'):
    os.remove(f'../statistic/static/graph/predict__{last}.csv')